  ...
  return (
    <section className="py-12 bg-[#111827]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#1a2744] rounded-3xl p-8 sm:p-12 border border-slate-700/80 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 lg:gap-8 relative z-10">
            ...
            <div className="flex flex-col items-stretch lg:items-end space-y-2.5 lg:flex-shrink-0">
              <button
                onClick={onOpenBookCall}
                className="bg-[#FF7300] hover:bg-[#E66800] active:scale-[0.98] text-white font-bold text-sm sm:text-base px-8 py-3.5 rounded-xl transition-all shadow-lg shadow-orange-950/40 flex items-center justify-center space-x-2.5 group cursor-pointer"
              >
